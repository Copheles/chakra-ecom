...
productRoutes.route('/reviews/:id').post(protectedRoute, createProductReview)
productRoutes.route('/').put(protectedRoute, admin, updateProduct)
productRoutes.route('/:id').delete(protectedRoute, admin, deleteProduct)
productRoutes.route('/').post(protectedRoute, admin, createProduct)
productRoutes.route('/:productId/:reviewId').put(protectedRoute, admin, removeProductReview);
